...
public class UserImpl implements UserService {
    ...
    public User create(String nome, String edv, String email, String password, String numero) {
        try {
            ...
            newUser.setImage(imageServ.UploadImage(ImageUtils.compressImage(Files.readAllBytes(Paths.get("C:\\Users\\disrct\\Desktop\\CR\\repositories\\Hackathon-\\HackaFusion\\src\\main\\java\\com\\example\\demo\\images\\user.png"))))); 
